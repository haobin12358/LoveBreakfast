...
messages_add_cart = "change shopping cart product number success !"
error_messagea_add_cart = "change shopping cart product number failed !"
messages_del_cart = "delete shopping cart product success !"
